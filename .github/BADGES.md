...
```markdown
![Git Validation](https://github.com/git@github.com:yvesmarinho/enterprise-evolui-crm.git/workflows/Git%20Validation/badge.svg)
```
...
```markdown
![CI](https://github.com/git@github.com:yvesmarinho/enterprise-evolui-crm.git/workflows/CI/badge.svg)
![CD](https://github.com/git@github.com:yvesmarinho/enterprise-evolui-crm.git/workflows/CD/badge.svg)
```
