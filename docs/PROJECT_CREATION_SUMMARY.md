...
**Projeto**: `enterprise-evolui-crm`
**Título**: Enterprise Evolui Crm
**Criado em**: 2026-07-10T12:21:36Z
...
| Propriedade | Valor |
|-------------|-------|
| **Nome** | enterprise-evolui-crm |
| **Descrição** | Whatsapp CRM |
| **Domínio** | programming |
| **Linguagem** | typescript |
| **Repositório** | git@github.com:yvesmarinho/enterprise-evolui-crm.git |
...
- Commit inicial: `chore: scaffold inicial do projeto enterprise-evolui-crm`
- Tag: `scaffold-v1.0.0` (marca versão do template)
- Branch: `master`
- Remote: `origin` → git@github.com:yvesmarinho/enterprise-evolui-crm.git
...
*Gerado automaticamente em 2026-07-10T12:21:36Z*
